...
console.log(`foodList.lastIndexOf('삼겹살') : ${foodList.lastIndexOf('삼겹살')}`);      // -1 없는 값 마이너스 출력
...
console.log(`chineseFood.pop() : ${chineseFood.pop()}`);        // 양장피 // pop: 배열의 마지막 요소 
...
// slice(시작인덱스, 종료인덱스)
// slice(start(인덱스의 시작값), end(인덱스의 종료값)) end : 요소의 값은 반환하지 않는다. start<= n < end
console.log(`front.slice(1, 3) : ${front.slice(1, 3)}`);                        // CSS,JavaScript //front -> 지정된 범위 살린다
...
//['HTML', 'CSS', 'JavaScript', 'jQuery'] 0,1,2,3 번째
// front.slice(3("jquery"), 1, "React") -> 3번째꺼부터 한개 -> ['HTML', 'CSS', 'JavaScript', "React"] 
